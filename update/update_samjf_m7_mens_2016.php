...
$mensagem = "Alterações ID = $id ";
	...
	if ($p73 != $p73_new)
		$mensagem .= "<br> p73 = $p73, para p73 = $p73_new";
...
$sql = "update samjf_m7_mens_2016 set p71='$p71_new',p72='$p72_new',p73='$p73_new',p74='$p74_new',p75='$p75_new' where id=$id";
