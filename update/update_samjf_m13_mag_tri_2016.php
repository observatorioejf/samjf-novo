...
$querySelect = ("select * from samjf_m13_mag_tri_2016 where id=$id");
...
$tabela = "samjf.samjf_m13_mag_tri_2016";
$sistema = "Samjf";
...
$sql = "update samjf_m13_mag_tri_2016 set p131='$p131_new',p132='$p132_new',p133='$p133_new' where id=$id";
