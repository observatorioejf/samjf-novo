...
$nomeTabela = "samjf_m12_mag_tri_2016";
...
$querySelect = ("select * from samjf_m12_mag_tri_2016 where id=$id");
...
$tabela = "samjf.samjf_m12_mag_tri_2016";
$sistema = "Samjf";
...
$sql = "update samjf_m12_mag_tri_2016 set p121='$p121_new',p122='$p122_new',p123='$p123_new' where id=$id";
