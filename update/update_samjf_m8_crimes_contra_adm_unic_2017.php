...
$tabela = "samjf_m8_crimes_contra_adm_unic_2016";
...
$querySelect = ("select * from samjf_m8_crimes_contra_adm_unic_2016 where id=$id");
...
$tabela = "samjf.samjf_m8_crimes_contra_adm_unic_2016";
$sistema = "Samjf";
...
$sql = "update samjf_m8_crimes_contra_adm_unic_2016 set p81='$p81_new', p82='$p82_new', p83='$p83_new' where id=$id";
