...
<head>
	...
	<script type="text/javascript">
		$(function(){
			...
			$('#dg').edatagrid({
				url: '../get/get_samjf_m8_trabescravo_exploracao_traficodepessoas_unic_2017.php',
				saveUrl: 'save_samjf_m8_trabescravo_exploracao_traficodepessoas_unic_2017.php',
				updateUrl: '../update/update_samjf_m8_trabescravo_exploracao_traficodepessoas_unic_2017.php',
				destroyUrl: 'destroy_samjf_m8_trabescravo_exploracao_traficodepessoas_unic_2017.php',
				fitColumns: true
			});
			var dg = $('#dg');
