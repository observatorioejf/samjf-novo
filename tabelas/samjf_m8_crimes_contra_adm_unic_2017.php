...
<head>
	...
	<script type="text/javascript">
		$(function(){
			...
			$('#dg').edatagrid({
				url: '../get/get_samjf_m8_crimes_contra_adm_unic_2017.php',
				saveUrl: 'save_samjf_m8_crimes_contra_adm_unic_2017.php',
				updateUrl: '../update/update_samjf_m8_crimes_contra_adm_unic_2017.php',
				destroyUrl: 'destroy_samjf_m8_crimes_contra_adm_unic_2017.php',
				fitColumns: true
			});
			var dg = $('#dg');
	...
	<table id="dg" title="" style="width:1000px;height:500px; border:1px solid #ccc;"
		...
		<thead>
			<tr>
				...
				<th field="tipo" width="220" editor="text">Tipo</th>
