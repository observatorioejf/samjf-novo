...
<head>
	...
	<script type="text/javascript">
		$(function(){
			...
			$('#dg').edatagrid({
				url: '../get/get_samjf_m8_trabescravo_exploracao_traficodepessoas_mens_2017.php',
				saveUrl: 'save_samjf_m8_trabescravo_exploracao_traficodepessoas_mens_2017.php',
				updateUrl: '../update/update_samjf_m8_trabescravo_exploracao_traficodepessoas_mens_2017.php',
				destroyUrl: 'destroy_samjf_m8_trabescravo_exploracao_traficodepessoas_mens_2017.php',
				fitColumns: true
			});
			var dg = $('#dg');
...
<body>
	...
	<h2>Meta 8. Trabalho escravo, exploração sexual e tráfico de pessoas. (Mensal)</h2>
	...
	<table id="dg" title="" style="width:1000px;height:500px; border:1px solid #ccc;"
		...
		<thead>
			<tr>
				...
				<th field="p83" width="30" editor="text">P8.4*</th>
			</tr>
