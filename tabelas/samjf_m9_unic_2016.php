...
<head>
	...
	<script type="text/javascript">
		$(function(){
			...
			$('#dg').edatagrid({
				url: '../get/get_samjf_m9_unic_2016.php',
				saveUrl: '',
				updateUrl: '../update/update_samjf_m9_unic_2016.php',
				destroyUrl: '',
				fitColumns: true
			});
			var dg = $('#dg');
	...
	<table id="dg" title="" style="width:1000px;height:500px; border:1px solid #ccc;"
		...
		<thead>
			<tr>
				...
				<th field="p91" width="50" editor="text">P9.1*</th>
				<th field="p92" width="50" editor="text">p9.2*</th>
