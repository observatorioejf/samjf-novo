...
<head>
	...
	<script type="text/javascript">
		$(function(){
			...
			$('#dg').edatagrid({
				url: '../get/get_samjf_m13_mag_tri_2016.php',
				saveUrl: '',
				updateUrl: '../update/update_samjf_m13_mag_tri_2016.php',
				destroyUrl: '',
				fitColumns: true
			});
			var dg = $('#dg');
...
<body>
	...
	<h2>Meta 14. Atingir 100% de adesão de magistrados ao exame de saúde periódico, até 2020.</h2>
	...
	<table id="dg" title="" style="width:700px;height:500px; border:1px solid #ccc;"
		...
		<thead>
			<tr>
				...
				<th field="p131" width="50" editor="text">P14.1*</th>
				<th field="p132" width="50" editor="text">P14.2*</th>			
				<!--<th field="p133" width="50" editor="text">P14.3*</th>-->
			</tr>
		</thead>
	</table>
	<div id="toolbar">
