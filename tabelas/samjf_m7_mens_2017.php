...
<head>
	...
	<script type="text/javascript">
		$(function(){
			...
			$('#dg').edatagrid({
				url: '../get/get_samjf_m7_mens_2017.php',
				saveUrl: '',
				updateUrl: '../update/update_samjf_m7_mens_2017.php',
				destroyUrl: '',
				fitColumns: true
			});
			var dg = $('#dg');
	...
	<table id="dg" title="" style="width:1000px;height:500px; border:1px solid #ccc;"
		...
		<thead>
			<tr>
				...
				<th field="p74" width="30" editor="text">P7.3*</th>
				<th field="p75" width="30" editor="text">P7.4*</th>
