...
<head>
	...
	<script type="text/javascript">
		$(function(){
			...
			$('#dg').edatagrid({
				url: '../get/get_samjf_m10_unic_2016.php',
				saveUrl: '',
				updateUrl: '../update/update_samjf_m10_unic_2016.php',
				destroyUrl: '',
				fitColumns: true
			});
			var dg = $('#dg');
	...
	<table id="dg" title="" style="width:1000px;height:500px; border:1px solid #ccc;"
		...
		<thead>
			<tr>
				...
				<th field="p101" width="50" editor="text">P10.1*</th>
				<th field="p102" width="50" editor="text">P10.2*</th>
				<th field="p103" width="50" editor="text">P10.3*</th>
				<th field="p104" width="50" editor="text">P10.4*</th>
				<th field="p105" width="50" editor="text">P10.5*</th>				
