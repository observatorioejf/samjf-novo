...
<head>
	...
	<script type="text/javascript">
		$(function(){
			...
			$('#dg').edatagrid({
				url: '../get/get_samjf_m8_crimes_contra_adm_mens_2016.php',
				saveUrl: 'save_samjf_m8_crimes_contra_adm_mens_2016.php',
				updateUrl: '../update/update_samjf_m8_crimes_contra_adm_mens_2016.php',
				destroyUrl: 'destroy_samjf_m8_crimes_contra_adm_mens_2016.php',
				fitColumns: true
			});
			var dg = $('#dg');
