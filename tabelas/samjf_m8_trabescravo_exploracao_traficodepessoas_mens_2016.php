...
<head>
	...
	<script type="text/javascript">
		$(function(){
			...
			$('#dg').edatagrid({
				url: '../get/get_samjf_m8_trabescravo_exploracao_traficodepessoas_mens_2016.php',
				saveUrl: 'save_samjf_m8_trabescravo_exploracao_traficodepessoas_mens_2016.php',
				updateUrl: '../update/update_samjf_m8_trabescravo_exploracao_traficodepessoas_mens_2016.php',
				destroyUrl: 'destroy_samjf_m8_trabescravo_exploracao_traficodepessoas_mens_2016.php',
				fitColumns: true
			});
			var dg = $('#dg');
	...
	<table id="dg" title="" style="width:1000px;height:500px; border:1px solid #ccc;"
		...
		<thead>
			<tr>
				...
				<th field="p83" width="30" editor="text">P8.3*</th>
			</tr>
