...
<head>
	...
	<script type="text/javascript">
		$(function(){
			...
			$('#dg').edatagrid({
				url: '../get/get_samjf_m12_mag_tri_2016.php',
				saveUrl: '',
				updateUrl: '../update/update_samjf_m12_mag_tri_2016.php',
				destroyUrl: '',
				fitColumns: true
			});
			var dg = $('#dg');
...
<body>
	...
	<h2>Meta 12. Manter, em todos os anos, o absenteísmo de magistrados abaixo ou igual a 3%. </h2>
	...
	<table id="dg" title="" style="width:700px;height:500px; border:1px solid #ccc;"
		...
		<thead>
			<tr>
				...
				<th field="p121" width="50" editor="text">P12.1*</th>
				<th field="p122" width="50" editor="text">P12.2*</th>			
				<th field="p123" width="50" editor="text">P12.3*</th>
			</tr>
		</thead>
	</table>
	<div id="toolbar">
